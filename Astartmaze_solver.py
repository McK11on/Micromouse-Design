...
if __name__=='__main__':
    ...
    searchPath,aPath,fwdPath=aStar(m,ini_cell)


    a=agent(m,ini_cell[0],ini_cell[1],footprints=True,color=COLOR.blue)
    b=agent(m,goal_cell[0],goal_cell[1],footprints=True,color=COLOR.yellow,filled=True,goal=ini_cell)
    c=agent(m,ini_cell[0],ini_cell[1],color=COLOR.red,goal=goal_cell,shape='arrow')
